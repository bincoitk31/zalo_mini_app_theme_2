...
const API_URL = import.meta.env.VITE_ENV == 'DEV' ? 'http://localhost:24679/mini_app_api' : import.meta.env.VITE_ENV == 'STAGING' ? "https://api.staging.storecake.io/mini_app_api" : "https://api.storecake.io/mini_app_api"
